...
public class ThongTinHoaDonController implements Initializable{
	...
	@FXML
	private Button quayLaiButton,xuatHoaDonButton;
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		xuatHoaDonButton.setOnAction(e -> printContent());
	}
	...
	private Node createPrintingContent() {
	    ...
	    for (CTHD cthd : cthdTable.getItems()) {
	        String tenMatHang = SanPhamDAO.getInstance().selectedById(cthd.getMaSp()).getTenSanPham();;
