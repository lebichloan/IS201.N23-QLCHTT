...
VALUES ('NV001', 'Nguyen Van A', 'Nam', TO_DATE('1990-01-01', 'YYYY-MM-DD'), '123 ABC Street, City', '0123456789', 'nva@example.com', 'Manager', TO_DATE('2010-01-01', 'YYYY-MM-DD'), 'admin', '123456', 'LND001');

INSERT INTO nhanvien (ma_nv, ho_ten, gioi_tinh, ngay_sinh, dia_chi, sdt, email, ghi_chu, ngay_vl, username, password, ma_lnd)
VALUES ('NV002', 'Tran Thi B', 'Nu', TO_DATE('1995-05-10', 'YYYY-MM-DD'), '456 XYZ Street, City', '9876543210', 'ttb@example.com', 'Salesperson', TO_DATE('2015-06-01', 'YYYY-MM-DD'), 'nhanvien01', '123987', 'LND002');

INSERT INTO nhanvien (ma_nv, ho_ten, gioi_tinh, ngay_sinh, dia_chi, sdt, email, ghi_chu, ngay_vl, username, password, ma_lnd)
VALUES ('NV003', 'Pham Van C', 'Nam', TO_DATE('1992-11-15', 'YYYY-MM-DD'), '789 PQR Street, City', '0123456789', 'pvc@example.com', 'Salesperson', TO_DATE('2018-03-15', 'YYYY-MM-DD'), 'snhanvien02', '123987', 'LND002');
...
DROP TRIGGER QLCHTT.KIEM_TRA_SLMH_HD;
DROP TRIGGER QLCHTT.CAP_NHAT_SLMH_HD;
DROP TRIGGER QLCHTT.KIEM_TRA_NGAY_LAP_HD;
DROP TRIGGER QLCHTT.TINH_TONG_TIEN_HD;
DROP TRIGGER QLCHTT.KIEM_TRA_SDT_KH;
DROP TRIGGER QLCHTT.CHECK_SO_LUONG;
DROP TRIGGER QLCHTT.KIEM_TRA_SLMH;
DROP TRIGGER QLCHTT.CAP_NHAT_SLMH;
